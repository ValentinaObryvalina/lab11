...
def task_1():
    ...
    restaurant1 = Restaurant("Vkusno i tochka", "Russia")
    restaurant2 = Restaurant("KFS", "USA")
    restaurant3 = Restaurant("Tokio food", "Japan")
    ...
    restaurant1 = Restaurant("KFS", "USA",
...
def task_2():
    ...
    restaurant1 = Restaurant("Tokyo food", "Japan")

    restaurant1.describe_restaurant()

    new_rating = restaurant1.update_rating(3.2)
